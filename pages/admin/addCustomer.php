...
<nav class="navbar navbar-expand-lg navbar-light">
    <div class="container-fluid">
        <div class="d-flex align-items-center">
            ...
            <a class="text-reset me-3" href="#">
                <li><a href="driversList.php" style="font-size:17.5px"><i class="fas fa-car-alt"
                                                                          style="margin:0px 5px;font-size:17.5px"></i>Drivers</a>
                </li>
            </a>
            <a class="text-reset me-3" href="#">
                                    ...
                                    <div class="card-body p-md-5 text-black">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 mb-4">
                                                <div class="form-outline">
                                                    <label for=""
                                                        ...
                                                        No</label>
                                                    <input class="form-control form-control-lg" name="phoneno"
                                            ...
                                            <div class="col-md-4 mb-4">
                                                <div class="form-outline">
                                                    <label for=""
                                                           style="display:block;font-size:17.5px;margin:5px auto">Password</label>
                                            ...
                                            <div class="col-md-4 mb-4">
                                                <div class="form-outline mb-4">
                                                    <label for=""
                                                           style="display:block;font-size:17.5px;margin:5px auto">Confirm
                                                        Password</label>
                                                    <input class="form-control form-control-lg" name="cpassword"
                                        ...
                                        <div class="d-flex justify-content-end pt-3">
                                            ...
                                            <button type="submit" class="btn btn-primary btn-lg ms-2">Submit form
                                            </button>
                                        </div>
