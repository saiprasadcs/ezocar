                                    ...
                                    <div class="row">
                                        <div class="col-md-4 mb-4">
                                            <div class="form-outline">
                                                ...
                                                <input  class="form-control form-control-lg" name="email" type="text" placeholder="Email Id" >
                                            </div>
                                        </div>
                                        <div class="col-md-4 mb-4">
                                            <div class="form-outline">
                                                <label for="" style="display:block;font-size:17.5px;margin:5px auto">Phone No</label>
                                                <input  class="form-control form-control-lg" name="phoneno" type="text" placeholder="Phone No" >
                                            </div>
                                        </div>
                                        <div class="col-md-4 mb-4">
                                            <div class="form-outline">
