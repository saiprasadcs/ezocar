    ...
    <div class="fullPage">
            ...
            <div class="loginPage" id="loginForm">
                <div class="formBox">
                    ...
                    <form class="inputGroupLogin" id="login"  method="POST">
                        ...
                        <a href="bookRide.php"
                           style="font-size:20px;padding:5px;margin:10px auto 0px auto;display:flex;text-align:center;
                           justify-cotent:center;align-items:center" type="submit" class="submitBtn">Log In</a>
                        </div>
                    </form>
                    ...
                    <a href="bookRide.php" class="submitBtn"  style="font-size:15px;width:60%;padding:10px;margin:17.5px auto 0px auto;display:flex;text-align:center;justify-cotent:center;align-items:center" >Register</a>
                </form>
                </div>
            </div>
        </div>
